...
Start up a terminal, and use the \cmnd{mkdir}{mkdir} to create a directory called \fname{htmlexample1} your home directory, and in that directory, use \cmnd{nano}{nano} to create a file called \fname{index.html} with the following content:
...
Use \cmnd{cd}{cd} to change to your home directory, and then \cmnd{curl}{curl} to fetch a tar of the example Mr Noodle web page that we've created for you from:
\\
