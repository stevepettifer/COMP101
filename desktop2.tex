...
\begin{note}
Do we really want them to ask a demonstrator?
\end{note}
...
and be overjoyed! (Okay, we'll settle for slightly chuffed here.)
...
{\small
\href{http://www.itservices.manchester.ac.uk/printing/pullprinting/}{www.itservices.manchester.ac.uk/printing/pullprinting}
}
...
We have now come to the end of the introductory labs, and what follows next week in the
various courses are real ones that will be marked and which count towards your final year mark. Especially
...
silence: speak to your personal tutor, or email one or all the team that created these tutorials. Best of luck!
\\

\begin{tabular}{ll}
Steve & steve.pettifer@manchester.ac.uk\\
Graham & graham.gough@manchester.ac.uk \\
Toby & toby.howard@manchester.ac.uk \\
John & john.latham@manchester.ac.uk \\
\end{tabular}

\includegraphics[width=5cm]{images/srp-mugshot}
\includegraphics[width=5cm]{images/gdg-mugshot}
\\

\includegraphics[width=5cm]{images/tljh-mugshot}
\includegraphics[width=5cm]{images/jtl-mugshot}
