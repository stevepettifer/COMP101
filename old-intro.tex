...
current directory (if you can't remember how -- slow down!).

Note that the version of
\cmdname{cd} that you are using also does something similar to \cmdname{pwd}.
...
%
The \cmdname{cd} command on its own takes you back to your home
...
\cmdname{ls} with the \cmdname{-R} flag. This shows the whole tree
below your current working directory (\cmdname{-R} is short for
...
chance to change your mind, or have the existing \fname{file2} overwritten
with a copy of \fname{file1}.
...
\cmdname{rm}, it is not reversible, although you will be asked to
confirm each remove.
