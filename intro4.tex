...
% \caption{\courseunit{COMP10120} Moodle Home Page}\label{figure:101-moodle-page}
% \end{figure}
...
\item Back on the course unit site, in the left hand panel you will find \emph{Course Tools}. This link leads you to a number of tools, including the \emph{General Course Discussion Forum}. There is also a direct link to this forum on the front page. You should subscribe to this forum now.

\item Also on the left hand side, under \emph{My Groups} on the left hand side,  you should find a link labelled with your tutorial group name. This is where the resources for your group can found, including a forum which can be used  be used to communicate with members of your group and a wiki in which you can  document your work. Again you should subscribe to this forum.
...
Most of you will have used discussion forums in some way or another, whether on your favourite social networking site or on some other website.
%Blackboard's forums aren't too different to any other, however, you should note a few things:
% \begin{note}
...
%Your turn
Visit your Group discussion forum on the \courseunit{COMP10120} site and click on \emph{Create Thread}  to begin a new discussion thread. Write a short forum posting to introduce you to your other group members and your tutor. Let them know where you are from, tell them a little bit about yourself.
...
During \courseunit{COMP10120} you'll be required to document many aspects of your work using a group wiki provided by Blackboard. You can find this wiki under \emph{My Groups} on the left hand side.
% Blackboard's wiki isn't as powerful as others you may have come across as it is primarily tailored towards teaching, but it does allow you to use Blackboard's standard in-line HTML editor to help you with formatting.
% Your turn
% \begin{quote}
%   \bfseries \textcolor{red}{I think this next bit needs changing as the current so-called personal test wiki is not personal at all, just a single instance wiki that anyone can enter. Ideally each student should be provided with a \emph{personal} wiki to play with, not visible to anyone else. Otherwise I think the Group wiki would be a better place for students to experiment, although nowhere near as good as a private sandpit.}
%This has now been fixed
% \end{quote}

%In the \emph{Other} column of the coloured Activities table on the \courseunit{COMP10120} front page you will find a link to a wiki called \emph{Personal test wiki} which is private for you and you only. It is provided to allow you to practise how to use Blackboard wiki syntax before you start using your shared group wiki. %%If you have used a wiki before then you may find Blackboard's wiki syntax is slightly different to that which you are used to (in some cases the reverse!).


% The aim of this short exercise is to create a simple wiki page with two or three wiki links to other pages; incorporate an image; and attach and link to a binary (non-image) file. 
...
Start by creating a page in your group wiki by clicking on \emph{Create Wiki Page}; it probably makes sense to include your name or initials in its title to avoid confusion with pages created by other group members. You will be presented with the Blackboard editor which won't have any content yet. 

Select the \emph{Submit} button. You should now see the first page of your wiki with the content you just added. You can add more content by selecting the \emph{Edit Wiki Content} tab.
...
You can find lots of information about Blackboard wikis at {\small\url{https://en-us.help.blackboard.com/Learn/Student/Interact/Wikis}}
...
% In the Student Guide to Using Blackboard\ course look at the help book on wikis and read the chapters titled \emph{Attaching binary files} and \emph{Linking to attached files}.  From your wiki's front page select the question mark link for the \emph{My files} link to create its page content. Attach your text file to the page from the wiki's Attachments tab as described in the \emph{Attaching binary files} chapter of the help book. Then return to the edit tab and add the following text:
...
At some time towards the end of this week, start your journal entry for the current week. Some brief notes about the process of Reflection can be found at \small{\url{https://online.manchester.ac.uk/bbcswebdav/courses/I3023-COMP-10120-1161-1YR-020952/Project_instructions/Reflection.html}}

% \subsection{CS UG Community Area}
% \label{sec:cs-ug-community}

% On your Blackboard home page you will find a link to \emph{CS UG Community}. This area of Blackboard contains general materials that are not related to any particular course unit; you will be using a couple of them over the next week or so. Please go to this area now and access the \emph{Student Photographic Consent Form and Collection Notice}. Please complete this now.
...
% % Look ahead on the \courseunit{COMP10120} site to get a feel for what you will be doing over the coming year.
