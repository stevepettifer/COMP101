...
If all went well in the last lab session, your Pi should be ready for use, but if you did not complete the Raspbian installation, please go back to the Intro 0 notes and finish it now.

In this session we are going to complete the setup of your Rapberry Pi and explore some of its capabilities. 
