...
Let's first see what stuff we already have on our Pi. The \cmnd{ls}{ls} command lists files and directories. Type it now, and you should see that a directory called \fname{python\_games} has already been created for you.
