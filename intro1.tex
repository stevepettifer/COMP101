...
Let's first see what stuff we already have on our Pi. The \cmnd{ls}{ls} command lists files and directories. Type it now, and you should see that two directories/folders have already been created for you, one called \fname{python\_games} and the other called \fname{Desktop} (and a file called \fname{ocr\_pi.png}). 

\begin{ttoutenv}
$ ls
Desktop ocr_pi.png python\_games
\end{ttoutenv}
