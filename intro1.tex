...
\\
making sure you save it in your home directory. By default, \ttout{curl} will just output whatever it has fetched to the screen. Use the option you learned about earlier to save it to a file called \fname{quake.tar.gz}.
