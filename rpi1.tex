...
The system we want to install to play this game is called \cmnd{frotz}{frotz} (to learn why, you'll have to play the game a bit, or look it up on Google) Let's try running the \cmnd{apt-get}{apt-get} command \textit{without} having gained superuser privilege first. Try typing:
