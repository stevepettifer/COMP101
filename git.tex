...
In your \fname{COMP10120} directory, create a new subdirectory called \fname{ex4}. In your \fname{aboutme} directory, run the \cmnd{git log}{git log} command, and redirect its output to a file called
\begin{center}
...
{\small \urlnop{studentnet.cs.manchester.ac.uk/ugt/labprint/readms.php?unit=COMP10120\&ex=ex4.xml}}
