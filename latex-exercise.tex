...
In this lab session you are going to write at least two documents using \LaTeX. You should also write brief notes in your logbook about how \LaTeX\ works and what commands you used inside the source of your documents. A portion of the assessment will be based on your logbook. 

\begin{note}
  Need to remove previous sentence or make it true
\end{note}
...
\taskss{Creating document structure}
%  \subsection{Task 3}
\label{sec:task-3}
...
\taskss{A reflection on your studies}
...
\taskss{Arguments about software patents}
...
\taskss{Formatting mathematics}
\label{sec:task-maths}
...
\taskss{A neat directory listing (optional)}
...
\taskss{A cleaning rota (optional)}
