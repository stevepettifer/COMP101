...
\caption{Scientific Linux's default graphical user interface and
  window manager, GNOME 3. \protect\circled{1} the top panel contains
...
It's quite common to refer to GNOME as a `window manager', but technically it is much more than that; it's actually a collection of tools, applications and other programs that together form a graphical desktop environment. The window manager component of GNOME 3 is called \wikipedia{Metacity}{metacity}.
\end{linux}
