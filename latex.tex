...
\begin{demonote}
  Here's a solution to this exercise. We have used the \fname{lipsum}
  package to generate the Lorem Ipsum text rather than cutting and
  pasting from the web. Note that the reference to the figure and a
...
also introduces some features of \LaTeX\ that will be new to you.
