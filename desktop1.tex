...
First, use lynx to look at the BBC's weather page at \url{http://www.bbc.co.uk/weather} and have a quick browse around to get familiar with what it looks like. Then quit \ttout{lynx} and get back to the command prompt before typing:
...
\item Use Firefox to visit the School UG home page
  \url{http://studentnet.cs.manchester.ac.uk/ugt/} and make this your
