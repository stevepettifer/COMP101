...
If you now start another terminal window and type \ttout{arcade}, what happens?

The way to make the change permanent is to modify your  \fname{.bash\_profile} file. Use \ttout{gedit} to modify this file by adding the following line at the end of the file
