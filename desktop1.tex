...
Your earlier use of the command line was on the computer's console, with no window manager running, but we now want to do similar things while X is running. The tool to use here is a \concept{terminal window}. You can fire up one of the these by choosing the ??? menu, then ????

Much of what you do in these and future labs will involve using terminal windows.
