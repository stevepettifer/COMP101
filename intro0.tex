...
You should see a configuration screen as shown in Figure \ref{figure:raspi-config}. Use the arrow keys to select Boot
Options, then press Tab several times  until \verb+<Select>+ is highlighted, then press Return. This will bring up another configuration screen. This time use the arrow keys to select the option `Text console, requiring user to login'. Again use Tab  several times  until \verb+<Select>+ is highlighted, then press Return. You should now be back at the original configuration screen where you should Tab to select \verb+<Finish>+ then press Return. 
