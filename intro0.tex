...
If you haven't done so already, please return to Section~\ref{page:raspbian-install} on page~\pageref{page:raspbian-install} to complete the Raspbian installation.
