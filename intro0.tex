...
If you haven't done so already, please return to Section~\ref{page:raspbian-install} on page~\pageref{page:raspbian-install} to complete the Raspbian installation. When you have completed the work for this session, please tell one of the lab staff, so we know how you're getting on.
